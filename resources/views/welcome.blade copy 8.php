    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" xmlns="http://www.w3.org/2000/svg">
            <rect width="100%" height="100%" fill="#333"/>
            <text x="50%" y="50%" fill="#fff" text-anchor="middle" dy=".3em" font-size="2rem">Gaya Elegan Anda</text>
          </svg>
        </div>
        <div class="carousel-item">
          <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" xmlns="http://www.w3.org/2000/svg">
            <rect width="100%" height="100%" fill="#444"/>
            <text x="50%" y="50%" fill="#fff" text-anchor="middle" dy=".3em" font-size="2rem">Koleksi Terbaru</text>
          </svg>
        </div>
        <div class="carousel-item">
          <svg class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" xmlns="http://www.w3.org/2000/svg">
            <rect width="100%" height="100%" fill="#555"/>
            <text x="50%" y="50%" fill="#fff" text-anchor="middle" dy=".3em" font-size="2rem">Diskon Menarik</text>
          </svg>
        </div>
      </div>
