...
<section class="hero-section text-white text-center d-flex align-items-center justify-content-center">
  ...
  <div class="hero-img-container">
    ...
    @endif
    {{-- <img src="https://mdbcdn.b-cdn.net/img/Photos/Horizontal/Nature/4-col/img%20(73).webp" class="img-fluid rounded" alt="Boat on Calm Water" /> --}}
    {{-- <img src="https://mdbcdn.b-cdn.net/img/Photos/Vertical/mountain1.webp" class="img-fluid rounded mt-3" alt="Wintry Mountain Landscape" /> --}}
  ...
  {{-- <div class="hero-content">
    <h1 class="display-2 fw-bold mb-3">MJS</h1>
    <p class="lead">Pusat CCTV & Keamanan Terpercaya</p>
  </div> --}}
</section>
...
.hero-section {
  position: relative;
  height: 100vh;
  background-image: url('img/cctv-bg.jpg'); /* Ganti dengan path gambar CCTV */
  ...
  <div class="row g-3">
    ...
    <div class="col-12 col-md-6 col-lg-4">
      ...
      <img
        ...
        class="img-fluid shadow rounded mt-3"
